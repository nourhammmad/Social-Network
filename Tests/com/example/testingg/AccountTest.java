...
public class AccountTest {
    ...
    public void is_Weak_Password(){
        assertThrows(IllegalArgumentException.class, ()->{new Account("Ahmed", "Wael", "Employee");});
    }

    @Test
    public void inCorrect_Role_Test(){
        // Only valid roles: Employee, Team Leader
        assertThrows(IllegalArgumentException.class, ()->{new Account("Ahmed", "waelibrahimmohamed", "Tester");});
    }
    ...
    public void addFollower_Test() {
        ...
        Account test_friend = new Account ("TestAccount", "erkabya3abdo123","Employee");
